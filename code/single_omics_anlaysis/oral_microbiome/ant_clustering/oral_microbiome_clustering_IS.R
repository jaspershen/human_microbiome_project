...
#######work directory
setwd(masstools::get_project_wd())
dir.create("data_analysis/oral_microbiome/clustering/Ant_phylum_IS",
           recursive = TRUE)
setwd("data_analysis/oral_microbiome/clustering/Ant_phylum_IS")
...
infection_idx <-
  which(oral_microbiome_sample_info$CL4 == "Ant")
...
#     dplyr::left_join(oral_microbiome_variable_info, by = "variable_id")
#   
#   openxlsx::write.xlsx(
#     x = cluster_data,
#     file = file.path(
