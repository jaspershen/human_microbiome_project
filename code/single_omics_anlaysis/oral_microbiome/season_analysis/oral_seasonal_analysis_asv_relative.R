...

{
  ...
  oral_microbiome_sample_info = object@sample_info
  oral_microbiome_expression_data = object@expression_data
  oral_microbiome_variable_info = object@variable_info
...
#######work directory
setwd(masstools::get_project_wd())
dir.create("data_analysis/oral_microbiome/season_analysis/asv_relative", recursive = TRUE)
setwd("data_analysis/oral_microbiome/season_analysis/asv_relative")
