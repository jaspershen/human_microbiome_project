...
#######work directory
setwd(masstools::get_project_wd())
dir.create("data_analysis/nasal_microbiome/season_analysis/asv_relative", recursive = TRUE)
setwd("data_analysis/nasal_microbiome/season_analysis/asv_relative")
