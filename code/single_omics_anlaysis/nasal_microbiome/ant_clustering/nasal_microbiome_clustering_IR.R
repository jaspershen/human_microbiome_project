...
#######work directory
setwd(masstools::get_project_wd())
dir.create("data_analysis/nasal_microbiome/clustering/Ant_phylum_IR",
           recursive = TRUE)
setwd("data_analysis/nasal_microbiome/clustering/Ant_phylum_IR")
...
infection_idx <-
  which(nasal_microbiome_sample_info$CL4 == "Ant")
