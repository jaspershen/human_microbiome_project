...
remain_idx = which(zero_percent < 1)
...
colnames(exposome_chemical_expression_data) <- colnames(skin_microbiome_expression_data)
...
# ggsave(
#   plot1,
#   filename = "exposome_chemical_skin_microbiome_correlation_network.pdf",
#   width = 8.5,
#   height = 7,
#   bg = "transparent"
# )
