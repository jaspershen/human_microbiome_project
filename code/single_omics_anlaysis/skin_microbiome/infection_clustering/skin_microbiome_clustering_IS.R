...
#######work directory
setwd(masstools::get_project_wd())
dir.create("data_analysis/skin_microbiome/clustering/phylum_IS",
           recursive = TRUE)
setwd("data_analysis/skin_microbiome/clustering/phylum_IS")
...
infection_idx <-
  which(skin_microbiome_sample_info$CL4 == "Infection")
