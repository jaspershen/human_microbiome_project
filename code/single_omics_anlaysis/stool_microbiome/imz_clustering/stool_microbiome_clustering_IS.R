...
#######work directory
setwd(masstools::get_project_wd())
dir.create("data_analysis/stool_microbiome/clustering/phylum_IS",
           recursive = TRUE)
setwd("data_analysis/stool_microbiome/clustering/phylum_IS")
...
infection_idx <-
  which(stool_microbiome_sample_info$CL4 == "Infection")
