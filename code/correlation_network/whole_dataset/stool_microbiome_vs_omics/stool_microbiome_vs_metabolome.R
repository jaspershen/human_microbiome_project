...
######work directory
setwd(masstools::get_project_wd())
setwd("data_analysis/correlation_network/whole_data_set/stool_microbiome_vs_metabolome")
...
#   lm_adjusted_cor(
#     microbiome_data = stool_microbiome_expression_data,
...
#   )
# 
# stool_microbiome_metabolome_lm_adjusted_cor_spearman = stool_microbiome_metabolome_lm_adjusted_cor[[1]]
# stool_microbiome_metabolome_lm_adjusted_cor_pearson = stool_microbiome_metabolome_lm_adjusted_cor[[2]]
# 
# plot(stool_microbiome_metabolome_lm_adjusted_cor_spearman$cor,
#      stool_microbiome_metabolome_lm_adjusted_cor_pearson$cor)
# 
# save(
#   stool_microbiome_metabolome_lm_adjusted_cor_spearman,
#   file = "stool_microbiome_metabolome_lm_adjusted_cor_spearman",
#   compress = "xz"
# )
# 
# save(
#   stool_microbiome_metabolome_lm_adjusted_cor_pearson,
#   file = "stool_microbiome_metabolome_lm_adjusted_cor_pearson",
#   compress = "xz"
# )

load("stool_microbiome_metabolome_lm_adjusted_cor_spearman")
load("stool_microbiome_metabolome_lm_adjusted_cor_pearson")

###step 2
###partial correlation

# stool_microbiome_metabolome_partial_cor =
#   partial_cor(
#     microbiome_data = stool_microbiome_expression_data,
#     metabolome_data = metabolome_expression_data,
#     sample_info = stool_microbiome_sample_info,
...
#   )
# 
# stool_microbiome_metabolome_partial_cor_spearman =
#   stool_microbiome_metabolome_partial_cor[[1]]
# 
# stool_microbiome_metabolome_partial_cor_pearson =
#   stool_microbiome_metabolome_partial_cor[[2]]
#   
# save(stool_microbiome_metabolome_partial_cor_spearman,
#      file = "stool_microbiome_metabolome_partial_cor_spearman", compress = "xz")
# 
# save(stool_microbiome_metabolome_partial_cor_pearson,
#      file = "stool_microbiome_metabolome_partial_cor_pearson", compress = "xz")

load("stool_microbiome_metabolome_partial_cor_spearman")
load("stool_microbiome_metabolome_partial_cor_pearson")

plot(stool_microbiome_metabolome_partial_cor_spearman$cor,
     stool_microbiome_metabolome_partial_cor_pearson$cor)

##step 3
#rmcorr
# stool_microbiome_metabolome_rmcor =
#   rm_cor(
#     microbiome_data = stool_microbiome_expression_data,
#     metabolome_data = metabolome_expression_data,
#     sample_info = stool_microbiome_sample_info
#   )
# save(stool_microbiome_metabolome_rmcor, file = "stool_microbiome_metabolome_rmcor", compress = "xz")
load("stool_microbiome_metabolome_rmcor")

sum(stool_microbiome_metabolome_lm_adjusted_cor_pearson$p_adjust < 0.05)
sum(stool_microbiome_metabolome_lm_adjusted_cor_spearman$p_adjust < 0.05)

sum(stool_microbiome_metabolome_rmcor$p_adjust < 0.05)

sum(stool_microbiome_metabolome_partial_cor_pearson$p_adjust < 0.05)
sum(stool_microbiome_metabolome_partial_cor_spearman$p_adjust < 0.05)

# ####calculate correlation for each subject
# stool_microbiome_metabolome_individual_cor_spearman =
#   individual_cor(microbiome_data = stool_microbiome_expression_data,
#                  metabolome_data = metabolome_expression_data,
#                  sample_info = stool_microbiome_sample_info,
#                  method = "spearman")
# 
# save(stool_microbiome_metabolome_individual_cor_spearman,
#      file =  "stool_microbiome_metabolome_individual_cor_spearman")

load("stool_microbiome_metabolome_individual_cor_spearman")

# stool_microbiome_metabolome_individual_cor_pearson =
#   individual_cor(microbiome_data = stool_microbiome_expression_data,
#                  metabolome_data = metabolome_expression_data,
#                  sample_info = stool_microbiome_sample_info,
#                  method = "pearson")
# 
# save(stool_microbiome_metabolome_individual_cor_pearson,
#      file =  "stool_microbiome_metabolome_individual_cor_pearson")

load("stool_microbiome_metabolome_individual_cor_pearson")

plot(stool_microbiome_metabolome_rmcor$cor, 
     stool_microbiome_metabolome_partial_cor_spearman$cor)

cor(stool_microbiome_metabolome_rmcor$cor, 
     stool_microbiome_metabolome_partial_cor_spearman$cor)

plot(stool_microbiome_metabolome_rmcor$cor, 
     stool_microbiome_metabolome_lm_adjusted_cor_spearman$cor)
...
plot <-
  ...
  scale_color_manual(values = omics_color[c("Metabolite", "Stool microbiome")]) +
