...
######work directory
setwd(masstools::get_project_wd())
setwd("data_analysis/correlation_network/whole_data_set/stool_microbiome_vs_lipidome")
...
stool_microbiome_lipidome_lm_adjusted_cor_pearson = stool_microbiome_lipidome_lm_adjusted_cor[[2]]
...
save(
  stool_microbiome_lipidome_lm_adjusted_cor_pearson,
  file = "stool_microbiome_lipidome_lm_adjusted_cor_pearson",
  compress = "xz"
)
