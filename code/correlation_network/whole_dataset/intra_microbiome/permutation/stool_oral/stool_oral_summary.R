...
for (i in 1:20) {
  ...
  load(
    paste0(
      "data_analysis/correlation_network/whole_data_set/stool_microbiome_vs_oral_microbiome/permutation/stool_microbiome_oral_microbiome_lm_adjusted_cor_spearman_",
      i
    )
  )
  ...
  load(
    "data_analysis/correlation_network/whole_data_set/stool_microbiome_vs_oral_microbiome/permutation/stool_oral_sample_wise_oral_dim"
  )
  
  load(
    "data_analysis/correlation_network/whole_data_set/stool_microbiome_vs_oral_microbiome/permutation/stool_oral_sample_wise_stool_dim"
  )
  ...
  sample_wise_number$theoretical_n[sample_wise_number$name == "oral_stool"] =
    (stool_oral_sample_wise_oral_dim[1] * (stool_oral_sample_wise_stool_dim[1] - 1)) /
    2
  ...
  # from <-
  #   sample_cor %>%
  #   dplyr::filter(class_name == "oral_stool") %>%
  #   pull(from) %>%
...
save(temp, file = "data_analysis/correlation_network/whole_data_set/stool_microbiome_vs_oral_microbiome/permutation/temp")
