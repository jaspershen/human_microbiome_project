...
for (i in 1:50) {
  ...
  sample_idx <-
    sample(
      1:ncol(nasal_microbiome_expression_data),
      ncol(nasal_microbiome_expression_data),
      replace = TRUE
    ) %>%
    unique() %>%
    sort()
  ...
  #   lm_adjusted_cor(
  #     data_set1 = nasal_microbiome_expression_data[, sample_idx],
  #     data_set2 = nasal_microbiome_expression_data[, sample_idx],
  #     sample_info = nasal_microbiome_sample_info[sample_idx, ],
  #     method = "all",
  #     threads = 8
  #   )
  # 
  ...
  # save(
  #   intra_nasal_microbiome_lm_adjusted_cor,
  #   file = paste0("intra_nasal_microbiome_lm_adjusted_cor_", i),
  #   compress = "xz"
  # )
...
intra_nasal_sample_wise_dim =
  nrow(nasal_microbiome_expression_data)

save(intra_nasal_sample_wise_dim,
     file = "intra_nasal_sample_wise_dim")
