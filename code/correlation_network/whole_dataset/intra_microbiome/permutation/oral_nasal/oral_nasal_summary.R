...
for (i in 1:20) {
  ...
  load(
    paste0(
      "data_analysis/correlation_network/whole_data_set/oral_microbiome_vs_nasal_microbiome/permutation/oral_microbiome_nasal_microbiome_lm_adjusted_cor_spearman_",
      i
    )
  )
  ...
  load(
    "data_analysis/correlation_network/whole_data_set/oral_microbiome_vs_nasal_microbiome/permutation/oral_nasal_sample_wise_nasal_dim"
  )
  
  load(
    "data_analysis/correlation_network/whole_data_set/oral_microbiome_vs_nasal_microbiome/permutation/oral_nasal_sample_wise_oral_dim"
  )
  ...
  sample_wise_number$theoretical_n[sample_wise_number$name == "nasal_oral"] =
    (oral_nasal_sample_wise_nasal_dim[1] * (oral_nasal_sample_wise_oral_dim[1] - 1)) /
    2
  ...
  # from <-
  #   sample_cor %>%
  #   dplyr::filter(class_name == "nasal_oral") %>%
  #   pull(from) %>%
...
save(temp, file = "data_analysis/correlation_network/whole_data_set/oral_microbiome_vs_nasal_microbiome/permutation/temp")
