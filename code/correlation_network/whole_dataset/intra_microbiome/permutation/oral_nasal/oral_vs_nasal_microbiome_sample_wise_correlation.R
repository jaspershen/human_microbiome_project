...
setwd(masstools::get_project_wd())
dir.create(
  "data_analysis/correlation_network/whole_data_set/oral_microbiome_vs_nasal_microbiome/permutation",
  recursive = TRUE
)
setwd(
  "data_analysis/correlation_network/whole_data_set/oral_microbiome_vs_nasal_microbiome/permutation"
...
for (i in 1:20) {
  ...
  save(
    oral_microbiome_nasal_microbiome_lm_adjusted_cor_spearman,
    file = paste0(
      "oral_microbiome_nasal_microbiome_lm_adjusted_cor_spearman_",
      i
    ),
    compress = "xz"
  )
