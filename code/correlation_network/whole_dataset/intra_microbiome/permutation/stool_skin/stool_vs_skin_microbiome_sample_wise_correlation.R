...
setwd(masstools::get_project_wd())
dir.create(
  "data_analysis/correlation_network/whole_data_set/stool_microbiome_vs_skin_microbiome/permutation",
  recursive = TRUE
)
setwd(
  "data_analysis/correlation_network/whole_data_set/stool_microbiome_vs_skin_microbiome/permutation"
...
for (i in 1:20) {
  ...
  save(
    stool_microbiome_skin_microbiome_lm_adjusted_cor_spearman,
    file = paste0(
      "stool_microbiome_skin_microbiome_lm_adjusted_cor_spearman_",
      i
    ),
    compress = "xz"
  )
