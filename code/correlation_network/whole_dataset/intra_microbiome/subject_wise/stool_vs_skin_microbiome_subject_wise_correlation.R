...
colnames(stool_data) == colnames(skin_data)


stool_skin_subject_wise_stool_dim = 
  dim(stool_data)

stool_skin_subject_wise_skin_dim = 
  dim(skin_data)

save(stool_skin_subject_wise_stool_dim, file = "stool_skin_subject_wise_stool_dim")
save(stool_skin_subject_wise_skin_dim, file = "stool_skin_subject_wise_skin_dim")
...
# tic()
# cor_data = 
# sparcc(data = t(rbind(stool_data1, skin_data1)), 
#        iter = 20, 
#        inner_iter = 10, 
#        th = 0.1)
# toc()
...
# 
# colnames(cor_data) = rownames(cor_data) = rownames(rbind(stool_data1, skin_data1))
# 
...
#       rownames(rbind(stool_data1, skin_data1))
#     
...
plot(log(as.numeric(stool_data1["stoolASV539",])+1, 10),
     log(as.numeric(skin_data1["skinOTU_384",]) + 1, 10))
...
plot(log(as.numeric(skin_data1["skinOTU_515",])+1, 10),
     log(as.numeric(skin_data1["skinOTU_506",]) + 1, 10))
