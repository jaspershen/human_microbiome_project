...
######work directory
setwd(masstools::get_project_wd())
setwd("data_analysis/correlation_network/whole_data_set/nasal_microbiome_vs_metabolome")
...
# nasal_microbiome_metabolome_lm_adjusted_cor_pearson = nasal_microbiome_metabolome_lm_adjusted_cor[[2]]
# 
# plot(nasal_microbiome_metabolome_lm_adjusted_cor_spearman$cor,
#      nasal_microbiome_metabolome_lm_adjusted_cor_pearson$cor)
# 
# save(
...
# 
# save(
#   nasal_microbiome_metabolome_lm_adjusted_cor_pearson,
#   file = "nasal_microbiome_metabolome_lm_adjusted_cor_pearson",
#   compress = "xz"
# )

load("nasal_microbiome_metabolome_lm_adjusted_cor_spearman")
load("nasal_microbiome_metabolome_lm_adjusted_cor_pearson")
...
#   )
# 
# nasal_microbiome_metabolome_partial_cor_spearman =
#   nasal_microbiome_metabolome_partial_cor[[1]]
# 
# nasal_microbiome_metabolome_partial_cor_pearson =
#   nasal_microbiome_metabolome_partial_cor[[2]]
# 
# save(nasal_microbiome_metabolome_partial_cor_spearman,
#      file = "nasal_microbiome_metabolome_partial_cor_spearman", compress = "xz")
# 
# save(nasal_microbiome_metabolome_partial_cor_pearson,
#      file = "nasal_microbiome_metabolome_partial_cor_pearson", compress = "xz")

load("nasal_microbiome_metabolome_partial_cor_spearman")
load("nasal_microbiome_metabolome_partial_cor_pearson")

plot(nasal_microbiome_metabolome_partial_cor_spearman$cor,
     nasal_microbiome_metabolome_partial_cor_pearson$cor)
...
#     sample_info = nasal_microbiome_sample_info
#   )
# save(nasal_microbiome_metabolome_rmcor,
#      file = "nasal_microbiome_metabolome_rmcor",
#      compress = "xz")
load("nasal_microbiome_metabolome_rmcor")

sum(nasal_microbiome_metabolome_lm_adjusted_cor_pearson$p_adjust < 0.05)
sum(nasal_microbiome_metabolome_lm_adjusted_cor_spearman$p_adjust < 0.05)

sum(nasal_microbiome_metabolome_rmcor$p_adjust < 0.05)

sum(nasal_microbiome_metabolome_partial_cor_pearson$p_adjust < 0.05)
sum(nasal_microbiome_metabolome_partial_cor_spearman$p_adjust < 0.05)

# ####calculate correlation for each subject
# nasal_microbiome_metabolome_individual_cor_spearman =
#   individual_cor(microbiome_data = nasal_microbiome_expression_data,
#                  metabolome_data = metabolome_expression_data,
#                  sample_info = nasal_microbiome_sample_info,
#                  method = "spearman")
# 
# save(nasal_microbiome_metabolome_individual_cor_spearman,
#      file =  "nasal_microbiome_metabolome_individual_cor_spearman")

load("nasal_microbiome_metabolome_individual_cor_spearman")

# nasal_microbiome_metabolome_individual_cor_pearson =
#   individual_cor(microbiome_data = nasal_microbiome_expression_data,
#                  metabolome_data = metabolome_expression_data,
#                  sample_info = nasal_microbiome_sample_info,
#                  method = "pearson")
# 
# save(nasal_microbiome_metabolome_individual_cor_pearson,
#      file =  "nasal_microbiome_metabolome_individual_cor_pearson")

load("nasal_microbiome_metabolome_individual_cor_pearson")


plot(nasal_microbiome_metabolome_rmcor$cor, 
     nasal_microbiome_metabolome_partial_cor_spearman$cor)

cor(nasal_microbiome_metabolome_rmcor$cor, 
     nasal_microbiome_metabolome_partial_cor_spearman$cor)

plot(nasal_microbiome_metabolome_rmcor$cor, 
     nasal_microbiome_metabolome_lm_adjusted_cor_spearman$cor)
...
sum(nasal_microbiome_metabolome_lm_adjusted_cor_spearman$p_adjust2 < 0.05)
sum(nasal_microbiome_metabolome_lm_adjusted_cor_pearson$p_adjust2 < 0.05)
