...
######work directory
setwd(masstools::get_project_wd())
dir.create("data_analysis/correlation_network/whole_data_set/skin_microbiome_vs_phenotype_sample_wise")
setwd("data_analysis/correlation_network/whole_data_set/skin_microbiome_vs_phenotype_sample_wise")
