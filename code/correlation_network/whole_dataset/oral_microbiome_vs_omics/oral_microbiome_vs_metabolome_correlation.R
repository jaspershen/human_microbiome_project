...
######work directory
setwd(masstools::get_project_wd())
setwd("data_analysis/correlation_network/whole_data_set/oral_microbiome_vs_metabolome")
...
#   lm_adjusted_cor(
#     microbiome_data = oral_microbiome_expression_data,
...
#   )
# 
# oral_microbiome_metabolome_lm_adjusted_cor_spearman = oral_microbiome_metabolome_lm_adjusted_cor[[1]]
# oral_microbiome_metabolome_lm_adjusted_cor_pearson = oral_microbiome_metabolome_lm_adjusted_cor[[2]]
# 
# plot(oral_microbiome_metabolome_lm_adjusted_cor_spearman$cor,
#      oral_microbiome_metabolome_lm_adjusted_cor_pearson$cor)
# 
# save(
#   oral_microbiome_metabolome_lm_adjusted_cor_spearman,
#   file = "oral_microbiome_metabolome_lm_adjusted_cor_spearman",
#   compress = "xz"
# )
# 
# save(
#   oral_microbiome_metabolome_lm_adjusted_cor_pearson,
#   file = "oral_microbiome_metabolome_lm_adjusted_cor_pearson",
#   compress = "xz"
# )

load("oral_microbiome_metabolome_lm_adjusted_cor_spearman")
load("oral_microbiome_metabolome_lm_adjusted_cor_pearson")

###step 2
###partial correlation

# oral_microbiome_metabolome_partial_cor =
#   partial_cor(
#     microbiome_data = oral_microbiome_expression_data,
#     metabolome_data = metabolome_expression_data,
#     sample_info = oral_microbiome_sample_info,
...
#   )
# 
# oral_microbiome_metabolome_partial_cor_spearman =
#   oral_microbiome_metabolome_partial_cor[[1]]
# 
# oral_microbiome_metabolome_partial_cor_pearson =
#   oral_microbiome_metabolome_partial_cor[[2]]
# 
# save(oral_microbiome_metabolome_partial_cor_spearman,
#      file = "oral_microbiome_metabolome_partial_cor_spearman", compress = "xz")
# 
# save(oral_microbiome_metabolome_partial_cor_pearson,
#      file = "oral_microbiome_metabolome_partial_cor_pearson", compress = "xz")

load("oral_microbiome_metabolome_partial_cor_spearman")
load("oral_microbiome_metabolome_partial_cor_pearson")

plot(oral_microbiome_metabolome_partial_cor_spearman$cor,
     oral_microbiome_metabolome_partial_cor_pearson$cor)

# #step 3
# ###rmcorr
# oral_microbiome_metabolome_rmcor =
#   rm_cor(
#     microbiome_data = oral_microbiome_expression_data,
#     metabolome_data = metabolome_expression_data,
#     sample_info = oral_microbiome_sample_info
#   )
# save(oral_microbiome_metabolome_rmcor,
#      file = "oral_microbiome_metabolome_rmcor",
#      compress = "xz")
# load("oral_microbiome_metabolome_rmcor")

sum(oral_microbiome_metabolome_lm_adjusted_cor_pearson$p_adjust < 0.05)
sum(oral_microbiome_metabolome_lm_adjusted_cor_spearman$p_adjust < 0.05)

plot(oral_microbiome_metabolome_lm_adjusted_cor_pearson$cor,
     oral_microbiome_metabolome_lm_adjusted_cor_spearman$cor)

sum(oral_microbiome_metabolome_rmcor$p_adjust < 0.05)

sum(oral_microbiome_metabolome_partial_cor_pearson$p_adjust < 0.05)
sum(oral_microbiome_metabolome_partial_cor_spearman$p_adjust < 0.05)

# ####calculate correlation for each subject
# oral_microbiome_metabolome_individual_cor_spearman =
#   individual_cor(microbiome_data = oral_microbiome_expression_data,
#                  metabolome_data = metabolome_expression_data,
#                  sample_info = oral_microbiome_sample_info,
#                  method = "spearman")
# 
# save(oral_microbiome_metabolome_individual_cor_spearman,
#      file =  "oral_microbiome_metabolome_individual_cor_spearman")

load("oral_microbiome_metabolome_individual_cor_spearman")

# oral_microbiome_metabolome_individual_cor_pearson =
#   individual_cor(microbiome_data = oral_microbiome_expression_data,
#                  metabolome_data = metabolome_expression_data,
#                  sample_info = oral_microbiome_sample_info,
#                  method = "pearson")
# 
# save(oral_microbiome_metabolome_individual_cor_pearson,
#      file =  "oral_microbiome_metabolome_individual_cor_pearson")

load("oral_microbiome_metabolome_individual_cor_pearson")


plot(oral_microbiome_metabolome_rmcor$cor, 
     oral_microbiome_metabolome_partial_cor_spearman$cor)
...
sum(oral_microbiome_metabolome_lm_adjusted_cor_spearman$p_adjust2 < 0.05)
sum(oral_microbiome_metabolome_lm_adjusted_cor_pearson$p_adjust2 < 0.05)
...
writeDataTable(wb, sheet = 2, x = edge_data,
               colNames = TRUE, rowNames = FALSE)
saveWorkbook(wb = wb, file = "oral_microbiome_vs_metabolome.xlsx", overwrite = TRUE)
...
plot <-
  ...
  scale_color_manual(values = omics_color[c("Metabolite", "Oral microbiome")]) +
