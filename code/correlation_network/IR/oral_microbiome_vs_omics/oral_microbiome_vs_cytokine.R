...
######work directory
setwd(masstools::get_project_wd())
dir.create("data_analysis/correlation_network/whole_data_set_IR/oral_microbiome_vs_cytokine")
setwd("data_analysis/correlation_network/whole_data_set_IR/oral_microbiome_vs_cytokine")
