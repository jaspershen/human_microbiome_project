...
######work directory
setwd(masstools::get_project_wd())
dir.create("data_analysis/correlation_network/IR/cytokine_vs_phenotype_sample_wise")
setwd("data_analysis/correlation_network/IR/cytokine_vs_phenotype_sample_wise")
