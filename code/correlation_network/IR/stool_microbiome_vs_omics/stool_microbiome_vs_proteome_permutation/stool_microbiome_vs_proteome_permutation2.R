...
####load data
{
  load("../stool_microbiome_vs_proteome_IR/stool_microbiome_expression_data")
  load("../stool_microbiome_vs_proteome_IR/stool_microbiome_variable_info")
  load("../stool_microbiome_vs_proteome_IR/stool_microbiome_sample_info")
  
  load("../stool_microbiome_vs_proteome_IR/proteome_expression_data")
  load("../stool_microbiome_vs_proteome_IR/proteome_variable_info")
  load("../stool_microbiome_vs_proteome_IR/proteome_sample_info")
}
