...
dir.create("data_analysis/correlation_network/IR/skin_microbiome_vs_phenotype_sample_wise")
setwd("data_analysis/correlation_network/IR/skin_microbiome_vs_phenotype_sample_wise")
