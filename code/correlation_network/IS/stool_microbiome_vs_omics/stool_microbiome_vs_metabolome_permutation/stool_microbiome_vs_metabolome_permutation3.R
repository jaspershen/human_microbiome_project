...
setwd(masstools::get_project_wd())
dir.create(
  "data_analysis/correlation_network/whole_data_set_IS/stool_microbiome_vs_metabolome_IS_permutation"
)
setwd(
  "data_analysis/correlation_network/whole_data_set_IS/stool_microbiome_vs_metabolome_IS_permutation"
)
...
####load data
{
  load("../stool_microbiome_vs_metabolome_IS/stool_microbiome_expression_data")
  load("../stool_microbiome_vs_metabolome_IS/stool_microbiome_variable_info")
  load("../stool_microbiome_vs_metabolome_IS/stool_microbiome_sample_info")
  
  load("../stool_microbiome_vs_metabolome_IS/metabolome_expression_data")
  load("../stool_microbiome_vs_metabolome_IS/metabolome_variable_info")
  load("../stool_microbiome_vs_metabolome_IS/metabolome_sample_info")
}
