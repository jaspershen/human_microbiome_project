...
dir.create("data_analysis/correlation_network/IS/oral_microbiome_vs_phenotype_sample_wise")
setwd("data_analysis/correlation_network/IS/oral_microbiome_vs_phenotype_sample_wise")
