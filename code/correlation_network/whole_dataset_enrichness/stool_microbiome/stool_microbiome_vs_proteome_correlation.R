...
setwd("data_analysis/correlation_network/whole_data_set_enrichness/stool_microbiome_vs_proteome")
...
###finally, for stool microbiome, 100 genus, for proteome, 302 proteins
###and 554 samples
...
#   )
# 
# stool_microbiome_proteome_lm_adjusted_cor_spearman = stool_microbiome_proteome_lm_adjusted_cor[[1]]
# 
# save(
#   stool_microbiome_proteome_lm_adjusted_cor_spearman,
#   file = "stool_microbiome_proteome_lm_adjusted_cor_spearman",
#   compress = "xz"
# )
...
plot <-
  ...
  scale_color_manual(values = omics_color[c("Proteome", "Stool microbiome")]) +
