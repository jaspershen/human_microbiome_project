...
setwd("data_analysis/correlation_network/whole_data_set_enrichness/nasal_microbiome_vs_proteome")
...
###finally, for nasal microbiome, 100 genus, for proteome, 302 proteins
###and 554 samples
