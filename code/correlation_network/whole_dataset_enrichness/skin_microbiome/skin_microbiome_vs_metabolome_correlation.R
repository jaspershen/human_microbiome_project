...
setwd("data_analysis/correlation_network/whole_data_set_enrichness/skin_microbiome_vs_metabolome")
...
skin_microbiome_variable_info = 
  data.frame(variable_id = rownames(skin_microbiome_expression_data),
...
###finally, for skin microbiome, 107 genus, for metabolome, 169 metabolites
...
sum(skin_microbiome_metabolome_lm_adjusted_cor_spearman$p_adjust < 0.2)
