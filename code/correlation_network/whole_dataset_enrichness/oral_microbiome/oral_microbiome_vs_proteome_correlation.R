...
setwd("data_analysis/correlation_network/whole_data_set_enrichness/oral_microbiome_vs_proteome")
...
oral_microbiome_variable_info =
  data.frame(
    variable_id = rownames(oral_microbiome_expression_data),
...
###finally, for oral microbiome, 100 genus, for proteome, 302 proteins
###and 554 samples
