...
setwd("data_analysis/correlation_network/whole_data_set_enrichness/oral_microbiome_vs_metabolome")
...
###finally, for oral microbiome, 107 genus, for metabolome, 169 metabolites
...
sum(oral_microbiome_metabolome_lm_adjusted_cor_spearman$p_adjust < 0.2)
