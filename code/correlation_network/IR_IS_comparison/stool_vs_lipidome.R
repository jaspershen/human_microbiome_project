...
dir.create("data_analysis/correlation_network/IR_vs_IS/stool_vs_lipidome",
           recursive = TRUE)
setwd("data_analysis/correlation_network/IR_vs_IS/stool_vs_lipidome")
...
ggsave(plot, filename = "stool_lipidome.pdf", width = 14, height = 7)
