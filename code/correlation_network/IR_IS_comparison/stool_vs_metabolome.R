...
dir.create("data_analysis/correlation_network/IR_vs_IS/stool_vs_metabolome",
           recursive = TRUE)
setwd("data_analysis/correlation_network/IR_vs_IS/stool_vs_metabolome")
...
ggsave(plot, filename = "stool_metabolome.pdf", width = 14, height = 7)
