...
###stool
{
  load("data_analysis/stool_microbiome/clustering/phylum_IR/new_expression_data")
  load("data_analysis/stool_microbiome/clustering/phylum_IR/new_sample_info")
  load("data_analysis/stool_microbiome/clustering/phylum_IR/new_variable_info")
...
###skin
{
  load("data_analysis/skin_microbiome/clustering/phylum_IR/new_expression_data")
  load("data_analysis/skin_microbiome/clustering/phylum_IR/new_sample_info")
  load("data_analysis/skin_microbiome/clustering/phylum_IR/new_variable_info")
...
###nasal
{
  load("data_analysis/nasal_microbiome/clustering/phylum_IR/new_expression_data")
  load("data_analysis/nasal_microbiome/clustering/phylum_IR/new_sample_info")
  load("data_analysis/nasal_microbiome/clustering/phylum_IR/new_variable_info")
...
###oral
{
  load("data_analysis/oral_microbiome/clustering/phylum_IR/new_expression_data")
  load("data_analysis/oral_microbiome/clustering/phylum_IR/new_sample_info")
  load("data_analysis/oral_microbiome/clustering/phylum_IR/new_variable_info")
...
###proteome
{
  load("data_analysis/proteome/clustering_IR/new_expression_data")
  load("data_analysis/proteome/clustering_IR/new_sample_info")
  load("data_analysis/proteome/clustering_IR/new_variable_info")
...
###metabolome
{
  load("data_analysis/metabolome/clustering_IR/new_expression_data")
  load("data_analysis/metabolome/clustering_IR/new_sample_info")
  load("data_analysis/metabolome/clustering_IR/new_variable_info")
...
###lipidome
{
  load("data_analysis/lipidome/clustering_IR/new_expression_data")
  load("data_analysis/lipidome/clustering_IR/new_sample_info")
  load("data_analysis/lipidome/clustering_IR/new_variable_info")
...
sum(rownames(temp_data) == variable_info$variable_id)

#######work directory
masstools::setwd_project()
dir.create("data_analysis/combine_omics/clustering_IR",
           recursive = TRUE)
setwd("data_analysis/combine_omics/clustering_IR")
