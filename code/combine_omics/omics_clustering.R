...
###proteome
{
  load("data_analysis/proteome/clustering/new_expression_data")
  load("data_analysis/proteome/clustering/new_sample_info")
  load("data_analysis/proteome/clustering/new_variable_info")
...
###metabolome
{
  load("data_analysis/metabolome/clustering/new_expression_data")
  load("data_analysis/metabolome/clustering/new_sample_info")
  load("data_analysis/metabolome/clustering/new_variable_info")
...
###lipidome
{
  load("data_analysis/lipidome/clustering/new_expression_data")
  load("data_analysis/lipidome/clustering/new_sample_info")
  load("data_analysis/lipidome/clustering/new_variable_info")
...
#######work directory
masstools::setwd_project()
dir.create("data_analysis/combine_omics/clustering",
           recursive = TRUE)
setwd("data_analysis/combine_omics/clustering")
