...
for (i in 1:100) {
  ...
  ###stool
  {
    load(
      file.path(
        "data_analysis/stool_microbiome/clustering/phylum_IR_permutation/",
  ...
  ###skin
  {
    load(
      file.path(
        "data_analysis/skin_microbiome/clustering/phylum_IR_permutation",
        paste("new_expression_data", i, sep = "_")
      )
    )
    load(
  ...
  ###nasal
  {
    load(
      file.path(
        "data_analysis/nasal_microbiome/clustering/phylum_IR_permutation",
        paste("new_expression_data", i, sep = "_")
      )
    )
    load(
  ...
  ###oral
  {
    load(
      file.path(
        "data_analysis/oral_microbiome/clustering/phylum_IR_permutation",
        paste("new_expression_data", i, sep = "_")
      )
    )
    load(
  ...
  {
    load(file.path(
      "data_analysis/proteome/clustering_IR_permutation",
      paste("new_expression_data", i, sep = "_")
    ))
    load(file.path(
      "data_analysis/proteome/clustering_IR_permutation",
  ...
  {
    load(file.path(
      "data_analysis/metabolome/clustering_IR_permutation",
      paste("new_expression_data", i, sep = "_")
    ))
    load(file.path(
      "data_analysis/metabolome/clustering_IR_permutation",
  ...
  {
    load(file.path(
      "data_analysis/lipidome/clustering_IR_permutation",
      paste("new_expression_data", i, sep = "_")
    ))
    load(file.path(
      "data_analysis/lipidome/clustering_IR_permutation",
  ...
  dir.create("data_analysis/combine_omics/clustering_IR_permutation", recursive = TRUE)
  write.table(
    temp_data,
    file = "data_analysis/combine_omics/clustering_IR_permutation/temp_data.txt",
    sep = '\t',
    quote = FALSE,
    col.names = NA
  )
  
  data <- table2eset(filename = "data_analysis/combine_omics/clustering_IR_permutation/temp_data.txt")
...
openxlsx::write.xlsx(
  cluster1,
  "data_analysis/combine_omics/clustering_IR/cluster_1/cluster1_with_p_value.xlsx"
)
...
#####cluster2
cluster2 <-
  readxl::read_xlsx("data_analysis/combine_omics/clustering_IR/cluster_2/cluster2.xlsx")
...
openxlsx::write.xlsx(
  cluster2,
  "data_analysis/combine_omics/clustering_IR/cluster_2/cluster2_with_p_value.xlsx"
)
...
openxlsx::write.xlsx(
  cluster3,
  "data_analysis/combine_omics/clustering_IR/cluster_3/cluster3_with_p_value.xlsx"
)
