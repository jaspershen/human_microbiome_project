...
for (i in 1:100) {
  ...
  ###stool
  {
    load(
      file.path(
        "data_analysis/stool_microbiome/clustering/phylum_permutation",
  ...
  ###skin
  {
    load(
      file.path(
        "data_analysis/skin_microbiome/clustering/phylum_permutation",
        paste("new_expression_data", i, sep = "_")
      )
    )
    load(
  ...
  ###nasal
  {
    load(
      file.path(
        "data_analysis/nasal_microbiome/clustering/phylum_permutation",
        paste("new_expression_data", i, sep = "_")
      )
    )
    load(
  ...
  ###oral
  {
    load(
      file.path(
        "data_analysis/oral_microbiome/clustering/phylum_permutation",
        paste("new_expression_data", i, sep = "_")
      )
    )
    load(
  ...
  {
    load(file.path(
      "data_analysis/proteome/clustering_permutation",
      paste("new_expression_data", i, sep = "_")
    ))
    load(file.path(
      "data_analysis/proteome/clustering_permutation",
  ...
  {
    load(file.path(
      "data_analysis/metabolome/clustering_permutation",
      paste("new_expression_data", i, sep = "_")
    ))
    load(file.path(
      "data_analysis/metabolome/clustering_permutation",
  ...
  {
    load(file.path(
      "data_analysis/lipidome/clustering_permutation",
      paste("new_expression_data", i, sep = "_")
    ))
    load(file.path(
      "data_analysis/lipidome/clustering_permutation",
  ...
  openxlsx::write.xlsx(
    x = cluster_info,
    file = file.path(
      "data_analysis/combine_omics/clustering_permutation",
...
original_info <-
  readxl::read_xlsx("data_analysis/combine_omics/clustering/cluster_info.xlsx") %>%
  as.data.frame()
...
cluster_idx <- 1
cluster1 <-
  readxl::read_xlsx("data_analysis/combine_omics/clustering/cluster_1/cluster1.xlsx")
...
p_value <-
  purrr::map2(cluster1$membership,
              random_membership, function(x, y) {
                1 - sum(y >= 0.4) / 100
              }) %>%
  unlist()
...
openxlsx::write.xlsx(cluster1, "data_analysis/combine_omics/clustering/cluster_1/cluster1_with_p_value.xlsx")
...
#####cluster2
cluster2 <-
  readxl::read_xlsx("data_analysis/combine_omics/clustering/cluster_2/cluster2.xlsx")
...
p_value <-
  purrr::map2(cluster2$membership,
              random_membership, function(x, y) {
                1 - sum(y >= 0.4) / 100
              }) %>%
  unlist()
...
openxlsx::write.xlsx(cluster2, "data_analysis/combine_omics/clustering/cluster_2/cluster2_with_p_value.xlsx")
...
#####cluster3
cluster3 <-
  readxl::read_xlsx("data_analysis/combine_omics/clustering/cluster_3/cluster3.xlsx")
...
p_value <-
  purrr::map2(cluster3$membership,
              random_membership, function(x, y) {
                1 - sum(y >= 0.4) / 100
              }) %>%
  unlist()
...
openxlsx::write.xlsx(cluster3, "data_analysis/combine_omics/clustering/cluster_3/cluster3_with_p_value.xlsx")
