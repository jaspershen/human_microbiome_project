...
###The days are highly significant, and now il17.logit has a pvalue of 0.09. 
##Given that we'd like to include it in the model, 
##the alpha threshold for variable selection will be defined as 0.1.
