...
# model.df there are three model.df IL17F.Rdata, IL17A.Rdata, IL22.Rdata
load("IL17F.Rdata")
model.df
# df.tax is microbes.Rdata
load("microbes.Rdata")
df.tax = df.tax
...
saveRDS(model.output, file = "model.output")
