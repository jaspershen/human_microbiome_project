...
################################
# stool.cytokine.model.output = vector(mode = "list", length = length(cytokines))
# names(stool.cytokine.model.output) = cytokines
for(i in 41:length(cytokines)) {
  cat(i, " ")
  c = cytokines[i]
  result = 
