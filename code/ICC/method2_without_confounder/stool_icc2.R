...
dir.create("data_analysis/stool_microbiome/ICC_without_confounder/")
save(vd_stool_asv2, file = "data_analysis/stool_microbiome/ICC_without_confounder/vd_stool_asv2")
...
dir.create("data_analysis/stool_microbiome/ICC_without_confounder/")
save(vd_stool_phylum2, file = "data_analysis/stool_microbiome/ICC_without_confounder/vd_stool_phylum2")
...
dir.create("data_analysis/stool_microbiome/ICC_without_confounder/")
save(vd_stool_order2, file = "data_analysis/stool_microbiome/ICC_without_confounder/vd_stool_order2")
...
dir.create("data_analysis/stool_microbiome/ICC_without_confounder/")
save(vd_stool_genus2, file = "data_analysis/stool_microbiome/ICC_without_confounder/vd_stool_genus2")
...
dir.create("data_analysis/stool_microbiome/ICC_without_confounder/")
save(vd_stool_family2, file = "data_analysis/stool_microbiome/ICC_without_confounder/vd_stool_family2")
...
dir.create("data_analysis/stool_microbiome/ICC_without_confounder/")
save(vd_stool_class2, file = "data_analysis/stool_microbiome/ICC_without_confounder/vd_stool_class2")
