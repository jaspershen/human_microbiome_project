...
save(vd_skin_asv2, file = "data_analysis/skin_microbiome/ICC/vd_skin_asv2")
...
dir.create("data_analysis/skin_microbiome/ICC/")
save(vd_skin_phylum2, file = "data_analysis/skin_microbiome/ICC/vd_skin_phylum2")
...
dir.create("data_analysis/skin_microbiome/ICC/")
save(vd_skin_order2, file = "data_analysis/skin_microbiome/ICC/vd_skin_order2")
...
dir.create("data_analysis/skin_microbiome/ICC/")
save(vd_skin_genus2, file = "data_analysis/skin_microbiome/ICC/vd_skin_genus2")
...
dir.create("data_analysis/skin_microbiome/ICC/")
save(vd_skin_family2, file = "data_analysis/skin_microbiome/ICC/vd_skin_family2")
...
dir.create("data_analysis/skin_microbiome/ICC/")
save(vd_skin_class2, file = "data_analysis/skin_microbiome/ICC/vd_skin_class2")
